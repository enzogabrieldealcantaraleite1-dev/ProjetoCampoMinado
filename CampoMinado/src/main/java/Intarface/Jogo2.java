      ...
      public void AdicionarBombas(){
       ...
       public void abrirbotao(int linha, int coluna){
           ...
           abertos[linha][coluna]=true;
              ...
              if(bombas[linha][coluna]){
                  ImageIcon imgBomba = new ImageIcon( getClass().getResource("/assets/bomba.png"));
                  botao.setIcon(imgBomba);
                      FinalizarJogo(false);
                  return;

              }else{
               ImageIcon imgBandeira = new ImageIcon( getClass().getResource("/assets/bandeira.png"));
       ...
       public void FinalizarJogo(boolean venceu){
           ...
           if(venceu){
              ...
              JOptionPane.showMessageDialog(
                      this,"nao fez mais que sua obrigacao");
            LimparJogo();  
           }else{
               JOptionPane.showMessageDialog(this,"kkkk como voce perdeu");  
               LimparJogo();
           }
       ...
       public void VerificarVitoria(){
           ...
           int casassembomba= 100 - quantidadedeBombas;
